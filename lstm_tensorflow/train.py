...
TRAIN_DATA_FILE = "../data/small_train.txt"
...
def make_model(labels_index, word_index):
    ...
    model = Sequential([
        embedded_sequences,
        LSTM(LSTM_SIZE, dropout=DROPOUT, recurrent_dropout=DROPOUT),
        Dense(2, input_shape(16000,), activation='sigmoid')
    ])
